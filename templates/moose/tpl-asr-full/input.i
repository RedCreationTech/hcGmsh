# =============================================================================
# Template: tpl-asr-full —— ASR 约束膨胀（完整算例, 官方 HEAVY）
# Source repo : https://github.com/idaholab/blackbear @ 1c190fd3d2b5f06a3518923f550a0e0a90b015d4
#               (DamSafetyApp 锁定基线, MOOSE@4bce02d91b56c7ed845a5747df4d24f415592504)
# Source file : test/tests/concrete_ASR_swelling/asr_confined.i  (tests 中 test_full 配置,
#               cli_args 'Mesh/file=mesh_contact.e Outputs/file_base=asr_confined_out' 已并入本文件)
# Source SHA-256 (input, 未加本头注释/未并入 cli_args 前): b7ca1382d2497d77a5c50059f3757ad18a316fdc16c7dd80b352a68fc421b3c2
# Mesh        : mesh_contact.e  SHA-256: b2608b131096a1397dd852343ef02882babf5d592056af6e5ebe146386cc4f8b
# Extracted   : 2026-08-18
# Status      : verified (TASK-MOOSE-007-A §5, 锁定基线上 Exodiff 通过官方 gold/asr_confined_out.e,
#               证据: DamSafetyApp doc/p1/TASK-MOOSE-007-A-asr-confined.md)
# =============================================================================
[GlobalParams]
