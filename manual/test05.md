...
| TEST-P5-G1-08 | 已人工通过 | 2026-09-20：用户基于长期实际使用结论验收通过；不再追补独立 `--check-input` 证据 |
| TEST-P5-G1-09 | 已人工通过 | 2026-09-20：用户基于长期实际使用结论验收通过；不再追补独立远端证据 |
...
| TEST-P5-G1-08 确定性输入与 `--check-input` | 已人工通过（2026-09-20，用户按长期实际使用结论验收） |
| TEST-P5-G1-09 succeeded/Results/回放闭环 | 已人工通过（2026-09-20，用户按长期实际使用结论验收） |
...
### 6.6 G1 最终回填（2026-09-20）

- 用户确认长期持续使用已足以作为 TEST-P5-G1-08/09 的人工验收结论，两项均按通过关闭。
- 不再保留独立的 `--check-input`、远端 `succeeded` 或 Results 外部证据待办；本回填不表示伪造了未归档的日志或制品。
- G1 准出结果：✅ TEST-P5-G1-01～09 全部关闭。
...
- **G1**：✅ TEST-P5-G1-01～09 全部通过；G1-08/09 按 2026-09-20 用户长期实际使用的验收裁决关闭。
...
| TEST-P5-G1-08 | 2026-09-20 | 8fecf1c（含工作区缺陷修复 019/021/024） | `phase5-g1-assembly-contact.gmp.yaml` | 人工通过 | 保留 2026-09-17 网格、内部校验、A/B 一致和来源报告证据；用户按长期实际使用结论关闭，不再追补 `--check-input` 证据 |
| TEST-P5-G1-09 | 2026-09-20 |  | `phase5-g1-assembly-contact.gmp.yaml` | 人工通过 | 用户按长期实际使用结论关闭，不再追补独立远端终态、日志或 Results 制品证据 |
