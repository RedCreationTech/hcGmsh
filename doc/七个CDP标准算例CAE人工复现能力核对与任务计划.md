...
|---|---|---|---|---|---|
| V01 单次拉伸 | QuasiStatic | ParsedFunction：`2.5e-05*t` | bottom Z；top X/Y 固定，top Z 加载 | 1 s；`nl_abs_tol=1e-8`；16 项 Physics 输出 | **✅ 达到 D（2026-09-21 人工闭环 + 2026-09-24 029～040 回归收口）** |
...
> **V01 标准算例原流程人工操作已完成（2026-09-21，达到 D）；过程中发现的 2026-09-21-029～2026-09-22-040 修复人工回归已全部收口（2026-09-24）。当前计数 1/7 达到 D，下一例为 V02（TASK-STDCAE-050）。**
...
| 4 | TASK-STDCAE-040 V01 首例 | ✅ 人工闭环完成（2026-09-21 操作 + 2026-09-24 029～040 回归收口） | 首个结构化人工闭环 + 操作文档 |
| 5 | TASK-STDCAE-050 V02/R02/G33 | 🟡 V02 待启动 | 4/7 结构化闭环 |
