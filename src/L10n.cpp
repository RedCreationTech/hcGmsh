...
const QHash<QString, QString>& zh_dict() {
  static const QHash<QString, QString> dict = {
      ...
      {"Add Surface Contact", "添加面接触"},
      {"Open Loads Root", "打开载荷根节点"},
      {"Add Generic Load", "添加通用载荷"},
      {"Add Body Force", "添加体力"},
      {"Add Surface Pressure", "添加面压力"},
      ...
      {"Open Selected Assembly Instance", "打开所选实例"},
      ...
      {"Apply Selected Volumes", "应用所选物理体"},
